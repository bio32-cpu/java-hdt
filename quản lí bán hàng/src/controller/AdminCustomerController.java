...
public class AdminCustomerController {
	...
	void initialize() throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
		...
		col_item_name = new TableColumn<CardUser, String>("Tên");
		col_item_age = new TableColumn<CardUser, String>("Tuổi");
		col_item_gender = new TableColumn<CardUser, String>("Giới tính");
		col_item_addr = new TableColumn<CardUser, String>("Địa chỉ");
		col_item_phone = new TableColumn<CardUser, String>("SĐT");
		col_item_email = new TableColumn<CardUser, String>("Email");
		col_item_card_no = new TableColumn<CardUser, String>("Số thẻ");
		col_item_amount = new TableColumn<CardUser, String>("Số dư");
		col_item_last_date_used = new TableColumn<CardUser, String>("Ngày dùng cuối");
		col_item_expired_date = new TableColumn<CardUser, String>("Ngày hết hạn");
		col_item_date_created = new TableColumn<CardUser, String>("Ngày tạo");
	...
	void onAddAction(ActionEvent event) throws SQLException {
		...
		if (tf_id.getText().equals("") || tf_name.getText().equals("") || tf_age.getText().equals("")
			...
			System.out.println("Ngày hết hạn is ssssss::::: " + expireddate);
			String gender = "";
