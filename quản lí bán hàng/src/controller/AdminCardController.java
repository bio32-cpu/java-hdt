...
public class AdminCardController {
	...
	void initialize() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
		...
		col_item_customer = new TableColumn<CardUser, String>("ID khách hàng");
		col_item_lastused_date = new TableColumn<CardUser, String>("Ngày dùng cuối");
		col_item_registerdate = new TableColumn<CardUser, String>("Ngày đăng ký");
		col_item_expiredate = new TableColumn<CardUser, String>("Ngày hết hạn");
