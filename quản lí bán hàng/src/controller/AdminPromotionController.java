...
public class AdminPromotionController {
	...
	void initialize() throws ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
		...
		col_item_product_id = new TableColumn<Promotion, String>("ID sản phẩm");
		col_item_product_name = new TableColumn<Promotion, String>("Tên sản phẩm");
		col_item_percentage = new TableColumn<Promotion, String>("Tỷ lệ phần trăm");
