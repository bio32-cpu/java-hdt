...
public class AdminPopularItemController {
    ...
    void initialize() throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException {
        ...
        col_item_barcode = new TableColumn<ProductItem, String>("Mã vạch");
        col_item_name = new TableColumn<ProductItem, String>("Tên");
        col_item_categroy = new TableColumn<ProductItem, String>("Loại");
        col_item_price = new TableColumn<ProductItem, String>("Giá");
        col_item_supplier = new TableColumn<ProductItem, String>("Nhà cung cấp");
        col_item_dateadded = new TableColumn<ProductItem, String>("Ngày Thêm");
        col_item_stock = new TableColumn<ProductItem, String>("Kho");
        col_item_expire_date = new TableColumn<ProductItem, String>("Ngày hết hạn");
        col_item_count = new TableColumn<ProductItem, String>("Số lượng");
